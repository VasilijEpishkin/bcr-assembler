...
make_native_browser(
  "/data/user/epishkin/results/ERP003950/annotator_compare/output/abstar/ERR346596/airr/ERR346596_200.tsv",
  "/data/user/epishkin/results/ERP003950/annotator_compare/igbrowser_ERR346596_abstar_first10.html",
  n=10,
  mode="abstar"
)

make_native_browser(
  "/data/user/epishkin/results/PRJNA900592/annotator_compare/output/abstar/SRR22279249/SRR22279249_200.tsv",
  "/data/user/epishkin/results/PRJNA900592/annotator_compare/igbrowser_SRR22279249_abstar_first10.html",
  n=10,
  mode="abstar"
)
